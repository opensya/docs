...
::u-page-grid
  ::u-page-card{title="Architecture" description="Understand the registry, engine, hooks, resolver, and adapter layers." icon="i-tabler-sitemap" to="/persistence/concepts/architecture"}
  ::
