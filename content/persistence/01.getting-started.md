...
The Drizzle adapter introspects base tables in PostgreSQL's `public` schema. See [Schema consistency](/docs/guides/schema-consistency) for the exact comparison rules and current introspection limits.
::
